...
public class StudentController {
    ...
    public ResponseEntity<?> createStudent(@RequestParam("name") String name,@RequestParam("surname") String surname, @RequestParam("midlename")String midlename) {
        System.out.println("Hello");
        Student student = new Student();
        student.setFirstName(name);
        student.setLastName(surname);
        student.setMiddleName(midlename);
